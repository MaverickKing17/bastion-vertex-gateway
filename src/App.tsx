...
const NAV_ITEMS = [
  ...
  { icon: ShieldAlert, label: 'Risk Inventory' },
...
export default function App() {
  const [activeTab, setActiveTab] = useState<'overview' | 'investigation'>('overview');
              ...
              <div className="grid grid-cols-12 gap-8">
                ...
                <div className="col-span-12 lg:col-span-4 space-y-8">
                  ...
                  <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-sm">
                    ...
                    <button className="w-full mt-10 py-3 rounded-xl border border-slate-800 text-[10px] font-black text-slate-500 uppercase tracking-widest hover:border-teal-400/30 hover:text-teal-400 transition-all">
                      View All Identities
                    </button>
                  </div>
                </div>
